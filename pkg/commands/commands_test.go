...
// Tests all 7 package managers (Homebrew, APT, YUM, Curl, Scoop, Chocolatey, Pacman) with all 27 supported tools.
func TestGetInstallCommand_ValidReturnsCommand(t *testing.T) {
	tools := []string{"git", "docker", "lazygit", "lazydocker", "htop", "nvim", "zsh", "tmux", "fzf", "ripgrep", "fd", "bat", "jq", "node", "gh", "eza", "zoxide", "starship", "python3", "delta", "tree", "make", "btop", "wget", "httpie", "tldr", "lazysql"}
...
// Tests all 27 supported tools and verifies invalid tools return empty.
